...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentationField.copy_from_field'
        db.add_column('credits_documentationfield', 'copy_from_field',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credits.DocumentationField'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentationField.copy_from_field'
        db.delete_column('credits_documentationfield', 'copy_from_field_id')
    ...
    models = {
        ...
        'credits.documentationfield': {
            ...
            'copy_from_field': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['credits.DocumentationField']", 'null': 'True', 'blank': 'True'}),
            'credit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['credits.Credit']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
