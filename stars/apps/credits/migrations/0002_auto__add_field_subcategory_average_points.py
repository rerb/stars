...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subcategory.average_points'
        db.add_column('credits_subcategory', 'average_points',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subcategory.average_points'
        db.delete_column('credits_subcategory', 'average_points')
