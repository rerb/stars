...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subcategory.passthrough'
        db.add_column('credits_subcategory', 'passthrough',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subcategory.passthrough'
        db.delete_column('credits_subcategory', 'passthrough')
