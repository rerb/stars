...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.is_metric'
        db.add_column('credits_unit', 'is_metric',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Unit.ratio'
        db.alter_column('credits_unit', 'ratio', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Unit.is_metric'
        db.delete_column('credits_unit', 'is_metric')


        # Changing field 'Unit.ratio'
        db.alter_column('credits_unit', 'ratio', self.gf('django.db.models.fields.FloatField')())
