...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DocumentationField.is_confidential'
        db.delete_column('credits_documentationfield', 'is_confidential')
    
    
    def backwards(self, orm):
        
        # Adding field 'DocumentationField.is_confidential'
        db.add_column('credits_documentationfield', 'is_confidential', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
