...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.equivalent'
        db.add_column('credits_unit', 'equivalent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credits.Unit'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.equivalent'
        db.delete_column('credits_unit', 'equivalent_id')
