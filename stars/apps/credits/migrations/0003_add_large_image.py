...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Rating.image'
        db.delete_column('credits_rating', 'image')

        # Adding field 'Rating.image_large'
        db.add_column('credits_rating', 'image_large', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Rating.image_200'
        db.add_column('credits_rating', 'image_200', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Rating.image'
        db.add_column('credits_rating', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Rating.image_large'
        db.delete_column('credits_rating', 'image_large')

        # Deleting field 'Rating.image_200'
        db.delete_column('credits_rating', 'image_200')
