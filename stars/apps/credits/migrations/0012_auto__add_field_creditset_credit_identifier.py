...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreditSet.credit_identifier'
        db.add_column('credits_creditset', 'credit_identifier', self.gf('django.db.models.fields.CharField')(default='get_1_0_identifier', max_length=25), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CreditSet.credit_identifier'
        db.delete_column('credits_creditset', 'credit_identifier')
