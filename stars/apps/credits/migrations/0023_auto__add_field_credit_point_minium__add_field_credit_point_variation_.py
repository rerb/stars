...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Credit.point_minium'
        db.add_column('credits_credit', 'point_minium',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Credit.point_variation_reason'
        db.add_column('credits_credit', 'point_variation_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Credit.point_value_formula'
        db.add_column('credits_credit', 'point_value_formula',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Credit.point_minium'
        db.delete_column('credits_credit', 'point_minium')

        # Deleting field 'Credit.point_variation_reason'
        db.delete_column('credits_credit', 'point_variation_reason')

        # Deleting field 'Credit.point_value_formula'
        db.delete_column('credits_credit', 'point_value_formula')
    ...
    models = {
        ...
        'credits.credit': {
            ...
            'ordinal': ('django.db.models.fields.SmallIntegerField', [], {'default': '-1'}),
            'point_minium': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
