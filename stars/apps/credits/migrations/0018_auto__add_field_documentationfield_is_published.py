...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentationField.is_published'
        db.add_column('credits_documentationfield', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DocumentationField.is_published'
        db.delete_column('credits_documentationfield', 'is_published')
