...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Credit.point_minimum'
        db.add_column('credits_credit', 'point_minimum',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Credit.point_minimum'
        db.delete_column('credits_credit', 'point_minimum')
