# -*- coding: utf-8 -*-
"""A simple migration to update the ratio attribute of a few Unit objects.
"""
import datetime
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for unit in [gross_square_metres, square_metres]:
            unit.ratio = 10.763910417
            unit.save()

        tons = orm.Unit.objects.get(name='Tons')
        tons.ratio = 0.9071847407607566
        tons.save()

        cubic_metres = orm.Unit.objects.get(name='Cubic Metres')
        cubic_metres.ratio = 264.172052
        cubic_metres.save()
