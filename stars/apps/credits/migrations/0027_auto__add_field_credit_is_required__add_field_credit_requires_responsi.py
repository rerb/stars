...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Credit.is_required'
        db.add_column('credits_credit', 'is_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Credit.requires_responsible_party'
        db.add_column('credits_credit', 'requires_responsible_party',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Credit.is_required'
        db.delete_column('credits_credit', 'is_required')

        # Deleting field 'Credit.requires_responsible_party'
        db.delete_column('credits_credit', 'requires_responsible_party')
