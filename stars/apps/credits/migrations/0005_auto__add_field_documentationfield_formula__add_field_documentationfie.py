...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentationField.formula'
        db.add_column('credits_documentationfield', 'formula',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'DocumentationField.imperial_formula_text'
        db.add_column('credits_documentationfield', 'imperial_formula_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DocumentationField.metric_formula_text'
        db.add_column('credits_documentationfield', 'metric_formula_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'DocumentationField.copy_from_field'
        db.alter_column('credits_documentationfield', 'copy_from_field_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credits.DocumentationField'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'DocumentationField.formula'
        db.delete_column('credits_documentationfield', 'formula')

        # Deleting field 'DocumentationField.imperial_formula_text'
        db.delete_column('credits_documentationfield', 'imperial_formula_text')

        # Deleting field 'DocumentationField.metric_formula_text'
        db.delete_column('credits_documentationfield', 'metric_formula_text')


        # Changing field 'DocumentationField.copy_from_field'
        db.alter_column('credits_documentationfield', 'copy_from_field_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credits.DocumentationField'], null=True))
    ...
    models = {
        ...
        'credits.documentationfield': {
            ...
            'copy_from_field': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['credits.DocumentationField']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'credit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['credits.Credit']"}),
