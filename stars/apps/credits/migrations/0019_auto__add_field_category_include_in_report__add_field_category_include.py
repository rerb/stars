...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.include_in_report'
        db.add_column('credits_category', 'include_in_report', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Category.include_in_score'
        db.add_column('credits_category', 'include_in_score', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.include_in_report'
        db.delete_column('credits_category', 'include_in_report')

        # Deleting field 'Category.include_in_score'
        db.delete_column('credits_category', 'include_in_score')
