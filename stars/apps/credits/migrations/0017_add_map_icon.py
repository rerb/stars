...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rating.map_icon'
        db.add_column('credits_rating', 'map_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Rating.map_icon'
        db.delete_column('credits_rating', 'map_icon')
