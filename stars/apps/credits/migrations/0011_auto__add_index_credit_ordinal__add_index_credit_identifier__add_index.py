...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Credit', fields ['ordinal']
        db.create_index('credits_credit', ['ordinal'])

        # Adding index on 'Credit', fields ['identifier']
        db.create_index('credits_credit', ['identifier'])

        # Adding index on 'DocumentationField', fields ['ordinal']
        db.create_index('credits_documentationfield', ['ordinal'])

        # Adding index on 'DocumentationField', fields ['type']
        db.create_index('credits_documentationfield', ['type'])

        # Adding index on 'DocumentationField', fields ['identifier']
        db.create_index('credits_documentationfield', ['identifier'])


    def backwards(self, orm):
        # Removing index on 'DocumentationField', fields ['identifier']
        db.delete_index('credits_documentationfield', ['identifier'])

        # Removing index on 'DocumentationField', fields ['type']
        db.delete_index('credits_documentationfield', ['type'])

        # Removing index on 'DocumentationField', fields ['ordinal']
        db.delete_index('credits_documentationfield', ['ordinal'])

        # Removing index on 'Credit', fields ['identifier']
        db.delete_index('credits_credit', ['identifier'])

        # Removing index on 'Credit', fields ['ordinal']
        db.delete_index('credits_credit', ['ordinal'])
