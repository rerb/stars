...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicabilityReason.ordinal'
        db.add_column('credits_applicabilityreason', 'ordinal', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApplicabilityReason.ordinal'
        db.delete_column('credits_applicabilityreason', 'ordinal')
