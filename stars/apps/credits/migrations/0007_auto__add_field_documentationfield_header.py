...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentationField.header'
        db.add_column('credits_documentationfield', 'header',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentationField.header'
        db.delete_column('credits_documentationfield', 'header')
