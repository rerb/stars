...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rating.publish_score'
        db.add_column('credits_rating', 'publish_score', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Rating.publish_score'
        db.delete_column('credits_rating', 'publish_score')
