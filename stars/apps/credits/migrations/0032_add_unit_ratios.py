...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for (unit, ratio) in [
                [acres, 0.404686], # to HECTARES
                [gallons, 0.00378541], # to CUBIC_METRES, 
                [gross_square_feet, 0.092903], # to GROSS_SQUARE_METRES
                [square_feet, 0.092903], # to SQUARE_METRES
                [tons, 7.185], # to METRIC_TONS
                [cubic_metres, 4.172], # to GALLONS
                [gross_square_metres, 0.7639], # to GROSS_SQUARE_FEET
                [hectares, 2.47105],  # to ACRES
                [metric_tons, 1.10231],  # to TONS
                [square_metres, 0.7639]  # to SQUARE_FEET
        ]:
            unit.ratio = ratio
            unit.save()
