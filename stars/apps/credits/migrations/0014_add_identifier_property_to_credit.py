...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Credit.identifier'
        db.add_column('credits_credit', 'identifier', self.gf('django.db.models.fields.CharField')(default='ID?', max_length=16), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Credit.identifier'
        db.delete_column('credits_credit', 'identifier')
