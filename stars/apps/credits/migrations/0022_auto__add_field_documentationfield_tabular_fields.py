...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentationField.tabular_fields'
        db.add_column('credits_documentationfield', 'tabular_fields',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentationField.tabular_fields'
        db.delete_column('credits_documentationfield', 'tabular_fields')
