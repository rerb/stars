...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Unit objects that already exist:
        ...
        # New Unit objects:
        cubic_metres, _ = orm.Unit.objects.get_or_create(name='Cubic Metres')
        gross_square_metres, _ = orm.Unit.objects.get_or_create(
            name='Gross Square Metres')
        hectares, _ = orm.Unit.objects.get_or_create(name='Hectares')
        square_metres, _ = orm.Unit.objects.get_or_create(name='Square Metres')
        metric_tons, _ = orm.Unit.objects.get_or_create(name='Metric Tons')
        # Now link equivalents:
        for (first, second) in [[acres, hectares],
                                [gallons, cubic_metres],
                                [gross_square_feet, gross_square_metres],
