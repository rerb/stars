...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubcategorySubmission.percentage_score'
        db.add_column('submissions_subcategorysubmission', 'percentage_score',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubcategorySubmission.adjusted_available_points'
        db.add_column('submissions_subcategorysubmission', 'adjusted_available_points',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubcategorySubmission.percentage_score'
        db.delete_column('submissions_subcategorysubmission', 'percentage_score')

        # Deleting field 'SubcategorySubmission.adjusted_available_points'
        db.delete_column('submissions_subcategorysubmission', 'adjusted_available_points')
    ...
    models = {
        ...
        'submissions.subcategorysubmission': {
            ...
            'adjusted_available_points': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'category_submission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['submissions.CategorySubmission']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'percentage_score': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
