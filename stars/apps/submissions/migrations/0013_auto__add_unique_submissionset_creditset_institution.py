...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SubmissionSet', fields ['creditset', 'institution']
        db.create_unique('submissions_submissionset', ['creditset_id', 'institution_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'SubmissionSet', fields ['creditset', 'institution']
        db.delete_unique('submissions_submissionset', ['creditset_id', 'institution_id'])
    ...
    models = {
        ...
        'submissions.submissionset': {
            'Meta': {'unique_together': "(('creditset', 'institution'),)", 'object_name': 'SubmissionSet'},
            'creditset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['credits.CreditSet']"}),
