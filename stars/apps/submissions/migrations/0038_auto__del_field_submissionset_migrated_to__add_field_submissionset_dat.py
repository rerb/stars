...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubmissionSet.migrated_to'
        db.delete_column('submissions_submissionset', 'migrated_to_id')

        # Adding field 'SubmissionSet.date_created'
        db.add_column('submissions_submissionset', 'date_created',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SubmissionSet.migrated_to'
        db.add_column('submissions_submissionset', 'migrated_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['submissions.SubmissionSet']),
                      keep_default=False)

        # Deleting field 'SubmissionSet.date_created'
        db.delete_column('submissions_submissionset', 'date_created')
    ...
    models = {
        ...
        'submissions.submissionset': {
            ...
            'migrated_from': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['submissions.SubmissionSet']"}),
