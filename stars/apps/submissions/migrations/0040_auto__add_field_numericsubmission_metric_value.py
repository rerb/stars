...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NumericSubmission.metric_value'
        db.add_column('submissions_numericsubmission', 'metric_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NumericSubmission.metric_value'
        db.delete_column('submissions_numericsubmission', 'metric_value')
