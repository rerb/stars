...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionSet.is_locked'
        db.add_column('submissions_submissionset', 'is_locked', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionSet.is_locked'
        db.delete_column('submissions_submissionset', 'is_locked')
