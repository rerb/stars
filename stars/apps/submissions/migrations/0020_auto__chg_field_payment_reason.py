...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('submissions_payment', 'reason', self.gf('django.db.models.fields.CharField')(max_length='16'))


    def backwards(self, orm):
        
        # Changing field 'Payment.reason'
        db.alter_column('submissions_payment', 'reason', self.gf('django.db.models.fields.CharField')(max_length='8'))
