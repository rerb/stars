...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CreditUserSubmission.responsible_party'
        db.alter_column('submissions_creditusersubmission', 'responsible_party_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submissions.ResponsibleParty'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'CreditUserSubmission.responsible_party'
        db.alter_column('submissions_creditusersubmission', 'responsible_party_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submissions.ResponsibleParty'], null=True))
