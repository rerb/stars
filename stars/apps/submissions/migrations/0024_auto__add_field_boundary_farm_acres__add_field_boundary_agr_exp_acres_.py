...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Boundary.farm_acres'
        db.add_column('submissions_boundary', 'farm_acres', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Boundary.agr_exp_acres'
        db.add_column('submissions_boundary', 'agr_exp_acres', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'Boundary.pharm_school_details'
        db.alter_column('submissions_boundary', 'pharm_school_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Boundary.sat_campus_details'
        db.alter_column('submissions_boundary', 'sat_campus_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Boundary.farm_details'
        db.alter_column('submissions_boundary', 'farm_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Boundary.pub_health_school_details'
        db.alter_column('submissions_boundary', 'pub_health_school_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Boundary.hospital_details'
        db.alter_column('submissions_boundary', 'hospital_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Boundary.med_school_details'
        db.alter_column('submissions_boundary', 'med_school_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Boundary.agr_exp_details'
        db.alter_column('submissions_boundary', 'agr_exp_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Boundary.ag_school_details'
        db.alter_column('submissions_boundary', 'ag_school_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Boundary.vet_school_details'
        db.alter_column('submissions_boundary', 'vet_school_details', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Boundary.farm_acres'
        db.delete_column('submissions_boundary', 'farm_acres')

        # Deleting field 'Boundary.agr_exp_acres'
        db.delete_column('submissions_boundary', 'agr_exp_acres')

        # User chose to not deal with backwards NULL issues for 'Boundary.pharm_school_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.pharm_school_details' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.sat_campus_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.sat_campus_details' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.farm_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.farm_details' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.pub_health_school_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.pub_health_school_details' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.hospital_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.hospital_details' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.med_school_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.med_school_details' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.agr_exp_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.agr_exp_details' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.ag_school_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.ag_school_details' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.vet_school_details'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.vet_school_details' and its values cannot be restored.")
