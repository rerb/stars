...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionSet.expired'
        db.add_column('submissions_submissionset', 'expired',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionSet.expired'
        db.delete_column('submissions_submissionset', 'expired')
