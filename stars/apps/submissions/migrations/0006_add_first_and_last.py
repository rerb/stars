...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionInquiry.first_name'
        db.add_column('submissions_submissioninquiry', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True), keep_default=False)

        # Adding field 'SubmissionInquiry.last_name'
        db.add_column('submissions_submissioninquiry', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionInquiry.first_name'
        db.delete_column('submissions_submissioninquiry', 'first_name')

        # Deleting field 'SubmissionInquiry.last_name'
        db.delete_column('submissions_submissioninquiry', 'last_name')
