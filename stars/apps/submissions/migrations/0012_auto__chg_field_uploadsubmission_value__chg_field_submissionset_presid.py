...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UploadSubmission.value'
        db.alter_column('submissions_uploadsubmission', 'value', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

        # Changing field 'SubmissionSet.presidents_letter'
        db.alter_column('submissions_submissionset', 'presidents_letter', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

        # Changing field 'SubmissionSet.pdf_report'
        db.alter_column('submissions_submissionset', 'pdf_report', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'UploadSubmission.value'
        db.alter_column('submissions_uploadsubmission', 'value', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'SubmissionSet.presidents_letter'
        db.alter_column('submissions_submissionset', 'presidents_letter', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'SubmissionSet.pdf_report'
        db.alter_column('submissions_submissionset', 'pdf_report', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        'submissions.subcategoryquartiles': {
        ...
        'submissions.submissionset': {
            ...
            'pdf_report': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'presidents_letter': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'submissions.uploadsubmission': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
