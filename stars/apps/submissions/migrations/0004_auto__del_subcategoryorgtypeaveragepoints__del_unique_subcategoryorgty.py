...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SubcategoryOrgTypeAveragePoints', fields ['subcategory', 'org_type']
        db.delete_unique('submissions_subcategoryorgtypeaveragepoints', ['subcategory_id', 'org_type'])

        # Deleting model 'SubcategoryOrgTypeAveragePoints'
        db.delete_table('submissions_subcategoryorgtypeaveragepoints')


        # Changing field 'SubmissionSet.date_created'
        db.alter_column('submissions_submissionset', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

    def backwards(self, orm):
        # Adding model 'SubcategoryOrgTypeAveragePoints'
        db.create_table('submissions_subcategoryorgtypeaveragepoints', (
            ('average_points', self.gf('django.db.models.fields.FloatField')(default=0)),
        ...
        db.send_create_signal('submissions', ['SubcategoryOrgTypeAveragePoints'])

        # Adding unique constraint on 'SubcategoryOrgTypeAveragePoints', fields ['subcategory', 'org_type']
        db.create_unique('submissions_subcategoryorgtypeaveragepoints', ['subcategory_id', 'org_type'])


        # Changing field 'SubmissionSet.date_created'
        db.alter_column('submissions_submissionset', 'date_created', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'submissions.subcategoryquartiles': {
            'Meta': {'unique_together': "(('subcategory', 'org_type'),)", 'object_name': 'SubcategoryQuartiles'},
            'first': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'fourth': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'org_type': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
