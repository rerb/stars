...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionSet.pdf_report'
        db.add_column('submissions_submissionset', 'pdf_report', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionSet.pdf_report'
        db.delete_column('submissions_submissionset', 'pdf_report')
