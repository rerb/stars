...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionSet.migrated_from'
        db.add_column('submissions_submissionset', 'migrated_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submissions.SubmissionSet'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionSet.migrated_from'
        db.delete_column('submissions_submissionset', 'migrated_from_id')
