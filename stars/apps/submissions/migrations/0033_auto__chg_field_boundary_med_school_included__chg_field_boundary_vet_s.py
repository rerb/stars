...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Boundary.med_school_included'
        db.alter_column('submissions_boundary', 'med_school_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.vet_school_present'
        db.alter_column('submissions_boundary', 'vet_school_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.ag_school_included'
        db.alter_column('submissions_boundary', 'ag_school_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.ag_school_present'
        db.alter_column('submissions_boundary', 'ag_school_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.med_school_present'
        db.alter_column('submissions_boundary', 'med_school_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.vet_school_included'
        db.alter_column('submissions_boundary', 'vet_school_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.pharm_school_present'
        db.alter_column('submissions_boundary', 'pharm_school_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.agr_exp_included'
        db.alter_column('submissions_boundary', 'agr_exp_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.farm_present'
        db.alter_column('submissions_boundary', 'farm_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.pub_health_school_present'
        db.alter_column('submissions_boundary', 'pub_health_school_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.hospital_present'
        db.alter_column('submissions_boundary', 'hospital_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.pub_health_school_included'
        db.alter_column('submissions_boundary', 'pub_health_school_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.sat_campus_included'
        db.alter_column('submissions_boundary', 'sat_campus_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.agr_exp_present'
        db.alter_column('submissions_boundary', 'agr_exp_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.sat_campus_present'
        db.alter_column('submissions_boundary', 'sat_campus_present', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.pharm_school_included'
        db.alter_column('submissions_boundary', 'pharm_school_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.farm_included'
        db.alter_column('submissions_boundary', 'farm_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Boundary.hospital_included'
        db.alter_column('submissions_boundary', 'hospital_included', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Boundary.med_school_included'
        db.alter_column('submissions_boundary', 'med_school_included', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.vet_school_present'
        db.alter_column('submissions_boundary', 'vet_school_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.ag_school_included'
        db.alter_column('submissions_boundary', 'ag_school_included', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.ag_school_present'
        db.alter_column('submissions_boundary', 'ag_school_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.med_school_present'
        db.alter_column('submissions_boundary', 'med_school_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.vet_school_included'
        db.alter_column('submissions_boundary', 'vet_school_included', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.pharm_school_present'
        db.alter_column('submissions_boundary', 'pharm_school_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.agr_exp_included'
        db.alter_column('submissions_boundary', 'agr_exp_included', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.farm_present'
        db.alter_column('submissions_boundary', 'farm_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.pub_health_school_present'
        db.alter_column('submissions_boundary', 'pub_health_school_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.hospital_present'
        db.alter_column('submissions_boundary', 'hospital_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.pub_health_school_included'
        db.alter_column('submissions_boundary', 'pub_health_school_included', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.sat_campus_included'
        db.alter_column('submissions_boundary', 'sat_campus_included', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.agr_exp_present'
        db.alter_column('submissions_boundary', 'agr_exp_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.sat_campus_present'
        db.alter_column('submissions_boundary', 'sat_campus_present', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.pharm_school_included'
        db.alter_column('submissions_boundary', 'pharm_school_included', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.farm_included'
        db.alter_column('submissions_boundary', 'farm_included', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Boundary.hospital_included'
        db.alter_column('submissions_boundary', 'hospital_included', self.gf('django.db.models.fields.BooleanField')())
