...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionInquiry.anonymous'
        db.add_column('submissions_submissioninquiry', 'anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'SubmissionInquiry.phone_number'
        db.alter_column('submissions_submissioninquiry', 'phone_number', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'SubmissionInquiry.city'
        db.alter_column('submissions_submissioninquiry', 'city', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'SubmissionInquiry.affiliation'
        db.alter_column('submissions_submissioninquiry', 'affiliation', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'SubmissionInquiry.state'
        db.alter_column('submissions_submissioninquiry', 'state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'SubmissionInquiry.email_address'
        db.alter_column('submissions_submissioninquiry', 'email_address', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):
        # Deleting field 'SubmissionInquiry.anonymous'
        db.delete_column('submissions_submissioninquiry', 'anonymous')


        # User chose to not deal with backwards NULL issues for 'SubmissionInquiry.phone_number'
        raise RuntimeError("Cannot reverse this migration. 'SubmissionInquiry.phone_number' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SubmissionInquiry.city'
        raise RuntimeError("Cannot reverse this migration. 'SubmissionInquiry.city' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SubmissionInquiry.affiliation'
        raise RuntimeError("Cannot reverse this migration. 'SubmissionInquiry.affiliation' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SubmissionInquiry.state'
        raise RuntimeError("Cannot reverse this migration. 'SubmissionInquiry.state' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SubmissionInquiry.email_address'
        raise RuntimeError("Cannot reverse this migration. 'SubmissionInquiry.email_address' and its values cannot be restored.")
