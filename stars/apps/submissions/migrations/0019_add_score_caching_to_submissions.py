...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionSet.score'
        db.add_column('submissions_submissionset', 'score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'SubcategorySubmission.points'
        db.add_column('submissions_subcategorysubmission', 'points', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'CategorySubmission.score'
        db.add_column('submissions_categorysubmission', 'score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionSet.score'
        db.delete_column('submissions_submissionset', 'score')

        # Deleting field 'SubcategorySubmission.points'
        db.delete_column('submissions_subcategorysubmission', 'points')

        # Deleting field 'CategorySubmission.score'
        db.delete_column('submissions_categorysubmission', 'score')
