...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('submissions_subcategoryquartiles', (
            ...
            ('institution_type', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
        ...
        # Adding unique constraint on 'SubcategoryQuartiles', fields ['subcategory', 'institution_type']
        db.create_unique('submissions_subcategoryquartiles', ['subcategory_id', 'institution_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'SubcategoryQuartiles', fields ['subcategory', 'institution_type']
        db.delete_unique('submissions_subcategoryquartiles', ['subcategory_id', 'institution_type'])
