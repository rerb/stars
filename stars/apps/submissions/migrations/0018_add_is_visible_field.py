...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionSet.is_visible'
        db.add_column('submissions_submissionset', 'is_visible', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionSet.is_visible'
        db.delete_column('submissions_submissionset', 'is_visible')
