...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubcategorySubmission.description'
        db.add_column('submissions_subcategorysubmission', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubcategorySubmission.description'
        db.delete_column('submissions_subcategorysubmission', 'description')
