...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditSubmission.is_unlocked_for_review'
        db.add_column('submissions_creditsubmission', 'is_unlocked_for_review',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditSubmission.is_unlocked_for_review'
        db.delete_column('submissions_creditsubmission', 'is_unlocked_for_review')
