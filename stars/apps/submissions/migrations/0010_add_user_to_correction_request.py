...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataCorrectionRequest.user'
        db.add_column('submissions_datacorrectionrequest', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'DataCorrectionRequest.user'
        db.delete_column('submissions_datacorrectionrequest', 'user_id')
