...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditSubmission.available_point_cache'
        db.add_column('submissions_creditsubmission', 'available_point_cache',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditSubmission.available_point_cache'
        db.delete_column('submissions_creditsubmission', 'available_point_cache')
    ...
    models = {
        ...
        'submissions.submissionset': {
            ...
            'migrated_from': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['submissions.SubmissionSet']", 'null': 'True'}),
