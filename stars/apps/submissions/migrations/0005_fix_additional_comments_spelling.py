...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubmissionInquiry.addtional_comments'
        db.delete_column('submissions_submissioninquiry', 'addtional_comments')

        # Adding field 'SubmissionInquiry.additional_comments'
        db.add_column('submissions_submissioninquiry', 'additional_comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'SubmissionInquiry.addtional_comments'
        db.add_column('submissions_submissioninquiry', 'addtional_comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'SubmissionInquiry.additional_comments'
        db.delete_column('submissions_submissioninquiry', 'additional_comments')
