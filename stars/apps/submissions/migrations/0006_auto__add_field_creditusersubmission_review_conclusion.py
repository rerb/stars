...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditUserSubmission.review_conclusion'
        db.add_column('submissions_creditusersubmission', 'review_conclusion',
                      self.gf('django.db.models.fields.CharField')(default='not-reviewed', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditUserSubmission.review_conclusion'
        db.delete_column('submissions_creditusersubmission', 'review_conclusion')
