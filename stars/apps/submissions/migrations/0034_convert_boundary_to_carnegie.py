...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
            Converting the institution boundary to use the updated
            institution types
        ...
        mappings = {
                    "2_year": "associate",
                    "4_year": "baccalaureate",
                    "graduate": "master"
                    }
        # Note: Remember to use orm['appname.ModelName'] rather than "from appname.models..."
        for b in orm['submissions.Boundary'].objects.all():
            if b.institution_type:
                b.institution_type = mappings[b.institution_type]
                b.save()
