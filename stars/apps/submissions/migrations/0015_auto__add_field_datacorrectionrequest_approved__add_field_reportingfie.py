...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataCorrectionRequest.approved'
        db.add_column('submissions_datacorrectionrequest', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'ReportingFieldDataCorrection.request'
        db.add_column('submissions_reportingfielddatacorrection', 'request', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='applied_correction', unique=True, null=True, to=orm['submissions.DataCorrectionRequest']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'DataCorrectionRequest.approved'
        db.delete_column('submissions_datacorrectionrequest', 'approved')

        # Deleting field 'ReportingFieldDataCorrection.request'
        db.delete_column('submissions_reportingfielddatacorrection', 'request_id')
