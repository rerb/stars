...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentationFieldFlag'
        db.create_table('submissions_documentationfieldflag', (
        ...
        db.send_create_signal('submissions', ['DocumentationFieldFlag'])


    def backwards(self, orm):
        # Deleting model 'DocumentationFieldFlag'
        db.delete_table('submissions_documentationfieldflag')
    ...
    models = {
        ...
        'submissions.documentationfieldflag': {
            'Meta': {'object_name': 'DocumentationFieldFlag'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
