...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportingFieldDataCorrection.explanation'
        db.add_column('submissions_reportingfielddatacorrection', 'explanation', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ReportingFieldDataCorrection.explanation'
        db.delete_column('submissions_reportingfielddatacorrection', 'explanation')
