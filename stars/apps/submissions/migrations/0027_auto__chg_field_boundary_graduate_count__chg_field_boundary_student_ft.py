...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Boundary.graduate_count'
        db.alter_column('submissions_boundary', 'graduate_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Boundary.student_ftc_percent'
        db.alter_column('submissions_boundary', 'student_ftc_percent', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Boundary.student_ptc_percent'
        db.alter_column('submissions_boundary', 'student_ptc_percent', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Boundary.climate_region'
        db.alter_column('submissions_boundary', 'climate_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.ClimateZone'], null=True))

        # Changing field 'Boundary.endowment_size'
        db.alter_column('submissions_boundary', 'endowment_size', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Boundary.fte_employmees'
        db.alter_column('submissions_boundary', 'fte_employmees', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Boundary.fte_students'
        db.alter_column('submissions_boundary', 'fte_students', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Boundary.institutional_control'
        db.alter_column('submissions_boundary', 'institutional_control', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Boundary.undergrad_count'
        db.alter_column('submissions_boundary', 'undergrad_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Boundary.gsf_lab_space'
        db.alter_column('submissions_boundary', 'gsf_lab_space', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Boundary.gsf_building_space'
        db.alter_column('submissions_boundary', 'gsf_building_space', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Boundary.institution_type'
        db.alter_column('submissions_boundary', 'institution_type', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Boundary.student_online_percent'
        db.alter_column('submissions_boundary', 'student_online_percent', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Boundary.student_residential_percent'
        db.alter_column('submissions_boundary', 'student_residential_percent', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Boundary.graduate_count'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.graduate_count' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.student_ftc_percent'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.student_ftc_percent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.student_ptc_percent'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.student_ptc_percent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.climate_region'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.climate_region' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.endowment_size'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.endowment_size' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.fte_employmees'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.fte_employmees' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.fte_students'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.fte_students' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.institutional_control'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.institutional_control' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.undergrad_count'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.undergrad_count' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.gsf_lab_space'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.gsf_lab_space' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.gsf_building_space'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.gsf_building_space' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.institution_type'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.institution_type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.student_online_percent'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.student_online_percent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Boundary.student_residential_percent'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.student_residential_percent' and its values cannot be restored.")
