...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubmissionInquiry.name'
        db.delete_column('submissions_submissioninquiry', 'name')
    
    
    def backwards(self, orm):
        
        # Adding field 'SubmissionInquiry.name'
        db.add_column('submissions_submissioninquiry', 'name', self.gf('django.db.models.fields.CharField')(default='-', max_length=128), keep_default=False)
