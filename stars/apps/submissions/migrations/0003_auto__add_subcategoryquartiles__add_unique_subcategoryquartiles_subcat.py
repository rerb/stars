...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'SubcategoryQuartiles', fields ['subcategory', 'org_type']
        db.delete_unique('submissions_subcategoryquartiles', ['subcategory_id', 'org_type'])
