...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CreditUserSubmission.review_status'
        db.delete_column('submissions_creditusersubmission', 'review_status')


    def backwards(self, orm):
        
        # Adding field 'CreditUserSubmission.review_status'
        db.add_column('submissions_creditusersubmission', 'review_status', self.gf('django.db.models.fields.CharField')(default='Bogus', max_length=8), keep_default=False)
