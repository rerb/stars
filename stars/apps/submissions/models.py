...
class Boundary(models.Model):
    ...
    student_residential_percent = models.FloatField('Percentage of students that are Residential')
    student_ftc_percent = models.FloatField('Percentage of students that are Full-time commuter')
    ...
    climate_region = models.ForeignKey(ClimateZone, help_text="See the <a href='http://www1.eere.energy.gov/buildings/building_america/climate_zones.html'>USDOE</a> site and <a href='http://www.ashrae.org/File%20Library/docLib/Public/20081111_cztables.pdf'>ASHRAE</a>  (international) for more information.")
