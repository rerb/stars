...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.amount_due'
        db.add_column('etl_export_subscription', 'amount_due', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.amount_due'
        db.delete_column('etl_export_subscription', 'amount_due')
