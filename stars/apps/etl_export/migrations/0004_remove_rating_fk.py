...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ETL.latest_rating'
        db.delete_column('etl_export_etl', 'latest_rating_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'ETL.latest_rating'
        db.add_column('etl_export_etl', 'latest_rating', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credits.Rating'], null=True, blank=True), keep_default=False)
