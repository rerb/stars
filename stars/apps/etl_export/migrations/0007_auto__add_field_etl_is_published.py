...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ETL.is_published'
        db.add_column('etl_export_etl', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ETL.is_published'
        db.delete_column('etl_export_etl', 'is_published')
