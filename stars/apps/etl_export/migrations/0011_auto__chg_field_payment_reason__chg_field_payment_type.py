...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.reason'
        db.alter_column('etl_export_payment', 'reason', self.gf('django.db.models.fields.CharField')(max_length='16'))

        # Changing field 'Payment.type'
        db.alter_column('etl_export_payment', 'type', self.gf('django.db.models.fields.CharField')(max_length='16'))


    def backwards(self, orm):
        
        # Changing field 'Payment.reason'
        db.alter_column('etl_export_payment', 'reason', self.gf('django.db.models.fields.CharField')(max_length='8'))

        # Changing field 'Payment.type'
        db.alter_column('etl_export_payment', 'type', self.gf('django.db.models.fields.CharField')(max_length='8'))
