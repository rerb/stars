...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Institution.rating_valid_until'
        db.delete_column('etl_export_institution', 'rating_valid_until')


    def backwards(self, orm):
        # Adding field 'Institution.rating_valid_until'
        db.add_column('etl_export_institution', 'rating_valid_until',
