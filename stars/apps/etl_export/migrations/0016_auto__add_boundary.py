...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('etl_export_boundary', (
            ...
            ('submissionset', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['etl_export.SubmissionSet'], unique=True)),
            ...
            ('endowment_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
