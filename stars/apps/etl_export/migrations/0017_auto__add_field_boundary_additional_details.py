...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('etl_export_boundary', 'additional_details', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Boundary.additional_details'
        db.delete_column('etl_export_boundary', 'additional_details')
