...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.delete_date'
        db.add_column('etl_export_institution', 'delete_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Boundary.delete_date'
        db.add_column('etl_export_boundary', 'delete_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubmissionSet.delete_date'
        db.add_column('etl_export_submissionset', 'delete_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subscription.delete_date'
        db.add_column('etl_export_subscription', 'delete_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubscriptionPayment.delete_date'
        db.add_column('etl_export_subscriptionpayment', 'delete_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.delete_date'
        db.delete_column('etl_export_institution', 'delete_date')

        # Deleting field 'Boundary.delete_date'
        db.delete_column('etl_export_boundary', 'delete_date')

        # Deleting field 'SubmissionSet.delete_date'
        db.delete_column('etl_export_submissionset', 'delete_date')

        # Deleting field 'Subscription.delete_date'
        db.delete_column('etl_export_subscription', 'delete_date')

        # Deleting field 'SubscriptionPayment.delete_date'
        db.delete_column('etl_export_subscriptionpayment', 'delete_date')
