...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('etl_export_institution', 'rated_submission_id')

        # Deleting field 'Institution.current_subscription'
        db.delete_column('etl_export_institution', 'current_subscription_id')

        # Deleting field 'Institution.current_submission'
        db.delete_column('etl_export_institution', 'current_submission_id')

        # Adding field 'Institution.current_submission_id'
        db.add_column('etl_export_institution', 'current_submission_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Institution.current_subscription_id'
        db.add_column('etl_export_institution', 'current_subscription_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Institution.rated_submission_id'
        db.add_column('etl_export_institution', 'rated_submission_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SubscriptionPayment.subscription'
        db.delete_column('etl_export_subscriptionpayment', 'subscription_id')

        # Adding field 'SubscriptionPayment.subscription_id'
        db.add_column('etl_export_subscriptionpayment', 'subscription_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('etl_export_institution', 'rated_submission',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='rated', null=True, to=orm['etl_export.SubmissionSet'], blank=True),
                      keep_default=False)

        # Adding field 'Institution.current_subscription'
        db.add_column('etl_export_institution', 'current_subscription',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='current', null=True, to=orm['etl_export.Subscription'], blank=True),
                      keep_default=False)

        # Adding field 'Institution.current_submission'
        db.add_column('etl_export_institution', 'current_submission',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='current', null=True, to=orm['etl_export.SubmissionSet'], blank=True),
                      keep_default=False)

        # Deleting field 'Institution.current_submission_id'
        db.delete_column('etl_export_institution', 'current_submission_id')

        # Deleting field 'Institution.current_subscription_id'
        db.delete_column('etl_export_institution', 'current_subscription_id')

        # Deleting field 'Institution.rated_submission_id'
        db.delete_column('etl_export_institution', 'rated_submission_id')


        # User chose to not deal with backwards NULL issues for 'SubscriptionPayment.subscription'
        raise RuntimeError("Cannot reverse this migration. 'SubscriptionPayment.subscription' and its values cannot be restored.")
        # Deleting field 'SubscriptionPayment.subscription_id'
        db.delete_column('etl_export_subscriptionpayment', 'subscription_id')
