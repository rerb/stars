...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.aashe_id'
        db.add_column('etl_export_payment', 'aashe_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.aashe_id'
        db.delete_column('etl_export_payment', 'aashe_id')
