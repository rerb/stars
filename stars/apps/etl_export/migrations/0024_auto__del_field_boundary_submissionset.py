...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Boundary.submissionset'
        db.delete_column('etl_export_boundary', 'submissionset_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Boundary.submissionset'
        raise RuntimeError("Cannot reverse this migration. 'Boundary.submissionset' and its values cannot be restored.")
