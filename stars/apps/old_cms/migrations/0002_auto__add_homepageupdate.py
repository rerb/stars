...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name('old_cms_newarticle_subcategories'))
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('old_cms_newarticle_subcategories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('newarticle', models.ForeignKey(orm['old_cms.newarticle'], null=False)),
            ('subcategory', models.ForeignKey(orm['old_cms.subcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['newarticle_id', 'subcategory_id'])
