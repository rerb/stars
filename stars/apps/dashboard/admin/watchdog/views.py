...
from stars.apps.dashboard.admin.watchdog.models import LOG_DURATION
...
def list(request):
    ...
    template = "dashboard/admin/watchdog/list.html"
...
def detail(request, entry_id):
    ...
    context = locals()
    template = "dashboard/admin/watchdog/detail.html"
    return respond(request, template, context)  
