...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TAApplication.resume'
        db.alter_column('custom_forms_taapplication', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'SteeringCommitteeNomination.resume'
        db.alter_column('custom_forms_steeringcommitteenomination', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'TAApplication.resume'
        db.alter_column('custom_forms_taapplication', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'SteeringCommitteeNomination.resume'
        db.alter_column('custom_forms_steeringcommitteenomination', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'custom_forms.steeringcommitteenomination': {
            ...
            'resume': ('django.db.models.fields.files.FileField', [], {'max_length': '255'}),
