...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataDisplayAccessRequest.date'
        db.add_column('custom_forms_datadisplayaccessrequest', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 2, 22, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataDisplayAccessRequest.date'
        db.delete_column('custom_forms_datadisplayaccessrequest', 'date')
