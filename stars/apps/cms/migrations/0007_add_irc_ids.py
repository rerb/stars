...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewArticle.irc_id'
        db.add_column('cms_newarticle', 'irc_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'NewArticle.irc_id'
        db.delete_column('cms_newarticle', 'irc_id')
