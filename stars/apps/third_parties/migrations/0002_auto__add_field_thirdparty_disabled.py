...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThirdParty.disabled'
        db.add_column('third_parties_thirdparty', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ThirdParty.disabled'
        db.delete_column('third_parties_thirdparty', 'disabled')
