...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.date_created'
        db.add_column('institutions_institution', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Institution.date_created'
        db.delete_column('institutions_institution', 'date_created')
