...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.executive_contact_address'
        db.add_column('institutions_institution', 'executive_contact_address', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Institution.executive_contact_city'
        db.add_column('institutions_institution', 'executive_contact_city', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Adding field 'Institution.executive_contact_state'
        db.add_column('institutions_institution', 'executive_contact_state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'Institution.executive_contact_zip'
        db.add_column('institutions_institution', 'executive_contact_zip', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Institution.executive_contact_address'
        db.delete_column('institutions_institution', 'executive_contact_address')

        # Deleting field 'Institution.executive_contact_city'
        db.delete_column('institutions_institution', 'executive_contact_city')

        # Deleting field 'Institution.executive_contact_state'
        db.delete_column('institutions_institution', 'executive_contact_state')

        # Deleting field 'Institution.executive_contact_zip'
        db.delete_column('institutions_institution', 'executive_contact_zip')
