...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.ms_id'
        db.add_column('institutions_subscription', 'ms_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subscription.ms_institution'
        db.add_column('institutions_subscription', 'ms_institution',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iss.Organization'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Subscription.ms_id'
        db.delete_column('institutions_subscription', 'ms_id')

        # Deleting field 'Subscription.ms_institution'
        db.delete_column('institutions_subscription', 'ms_institution_id')


        # User chose to not deal with backwards NULL issues for 'Subscription.institution'
        raise RuntimeError("Cannot reverse this migration. 'Subscription.institution' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Subscription.institution'
        db.alter_column('institutions_subscription', 'institution_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.Institution']))
