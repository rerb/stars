...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.ms_institution'
        db.add_column('institutions_institution', 'ms_institution',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['iss.Organization'], unique=True, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.ms_institution'
        db.delete_column('institutions_institution', 'ms_institution_id')
