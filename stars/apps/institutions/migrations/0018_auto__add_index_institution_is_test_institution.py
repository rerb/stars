...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Institution', fields ['is_test_institution']
        db.create_index('institutions_institution', ['is_test_institution'])


    def backwards(self, orm):
        # Removing index on 'Institution', fields ['is_test_institution']
        db.delete_index('institutions_institution', ['is_test_institution'])
    ...
    models = {
        ...
        'institutions.institution': {
            ...
            'is_test_institution': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
