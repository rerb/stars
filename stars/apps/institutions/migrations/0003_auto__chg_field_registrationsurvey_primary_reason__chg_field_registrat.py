...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegistrationSurvey.primary_reason'
        db.alter_column('institutions_registrationsurvey', 'primary_reason_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['institutions.RegistrationReason']))

        # Changing field 'RegistrationSurvey.source'
        db.alter_column('institutions_registrationsurvey', 'source', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'RegistrationSurvey.primary_reason'
        db.alter_column('institutions_registrationsurvey', 'primary_reason_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.RegistrationReason']))

        # Changing field 'RegistrationSurvey.source'
        db.alter_column('institutions_registrationsurvey', 'source', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'institutions.registrationsurvey': {
            ...
            'reasons': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['institutions.RegistrationReason']", 'null': 'True', 'blank': 'True'}),
