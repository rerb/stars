...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Institution.contact_phone'
        db.delete_column('institutions_institution', 'contact_phone')


    def backwards(self, orm):
        # Adding field 'Institution.contact_phone_ext'
        db.add_column('institutions_institution', 'contact_phone_ext',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Institution.contact_phone'
        db.add_column('institutions_institution', 'contact_phone',
