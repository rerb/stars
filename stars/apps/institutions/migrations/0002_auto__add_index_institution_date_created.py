...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Institution', fields ['date_created']
        db.create_index('institutions_institution', ['date_created'])


    def backwards(self, orm):
        # Removing index on 'Institution', fields ['date_created']
        db.delete_index('institutions_institution', ['date_created'])
