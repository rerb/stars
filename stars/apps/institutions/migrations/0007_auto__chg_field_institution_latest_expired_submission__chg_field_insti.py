...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Institution.latest_expired_submission'
        db.alter_column('institutions_institution', 'latest_expired_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['submissions.SubmissionSet']))

        # Changing field 'Institution.rated_submission'
        db.alter_column('institutions_institution', 'rated_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['submissions.SubmissionSet']))

        # Changing field 'Institution.current_subscription'
        db.alter_column('institutions_institution', 'current_subscription_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['institutions.Subscription']))

        # Changing field 'Institution.current_submission'
        db.alter_column('institutions_institution', 'current_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['submissions.SubmissionSet']))

    def backwards(self, orm):

        # Changing field 'Institution.latest_expired_submission'
        db.alter_column('institutions_institution', 'latest_expired_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['submissions.SubmissionSet']))

        # Changing field 'Institution.rated_submission'
        db.alter_column('institutions_institution', 'rated_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['submissions.SubmissionSet']))

        # Changing field 'Institution.current_subscription'
        db.alter_column('institutions_institution', 'current_subscription_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['institutions.Subscription']))

        # Changing field 'Institution.current_submission'
        db.alter_column('institutions_institution', 'current_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['submissions.SubmissionSet']))
    ...
    models = {
        ...
        'institutions.institution': {
            ...
            'current_submission': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'current'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['submissions.SubmissionSet']"}),
            'current_subscription': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'current'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['institutions.Subscription']"}),
            ...
            'latest_expired_submission': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'latest_expired'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['submissions.SubmissionSet']"}),
            'ms_institution': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['iss.Organization']", 'unique': 'True', 'null': 'True'}),
            ...
            'rated_submission': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'rated'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['submissions.SubmissionSet']"}),
        ...
        'institutions.subscription': {
            ...
            'ms_institution': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['iss.Organization']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
