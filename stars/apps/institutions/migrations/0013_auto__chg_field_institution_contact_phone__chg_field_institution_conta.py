...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Institution.contact_phone'
        db.alter_column('institutions_institution', 'contact_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Institution.contact_title'
        db.alter_column('institutions_institution', 'contact_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Institution.contact_department'
        db.alter_column('institutions_institution', 'contact_department', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Institution.contact_email'
        db.alter_column('institutions_institution', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Institution.contact_phone'
        raise RuntimeError("Cannot reverse this migration. 'Institution.contact_phone' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Institution.contact_phone'
        db.alter_column('institutions_institution', 'contact_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20))

        # User chose to not deal with backwards NULL issues for 'Institution.contact_title'
        raise RuntimeError("Cannot reverse this migration. 'Institution.contact_title' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Institution.contact_title'
        db.alter_column('institutions_institution', 'contact_title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'Institution.contact_department'
        raise RuntimeError("Cannot reverse this migration. 'Institution.contact_department' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Institution.contact_department'
        db.alter_column('institutions_institution', 'contact_department', self.gf('django.db.models.fields.CharField')(max_length=64))

        # User chose to not deal with backwards NULL issues for 'Institution.contact_email'
        raise RuntimeError("Cannot reverse this migration. 'Institution.contact_email' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Institution.contact_email'
        db.alter_column('institutions_institution', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75))
