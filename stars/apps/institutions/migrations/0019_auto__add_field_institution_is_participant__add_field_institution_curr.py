...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.is_participant'
        db.add_column('institutions_institution', 'is_participant', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Institution.current_rating'
        db.add_column('institutions_institution', 'current_rating', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credits.Rating'], null=True, blank=True), keep_default=False)

        # Adding field 'Institution.rating_expires'
        db.add_column('institutions_institution', 'rating_expires', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Institution.current_submission'
        db.add_column('institutions_institution', 'current_submission', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='current', null=True, to=orm['submissions.SubmissionSet']), keep_default=False)

        # Adding field 'Institution.current_subscription'
        db.add_column('institutions_institution', 'current_subscription', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='current', null=True, to=orm['institutions.Subscription']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Institution.is_participant'
        db.delete_column('institutions_institution', 'is_participant')

        # Deleting field 'Institution.current_rating'
        db.delete_column('institutions_institution', 'current_rating_id')

        # Deleting field 'Institution.rating_expires'
        db.delete_column('institutions_institution', 'rating_expires')

        # Deleting field 'Institution.current_submission'
        db.delete_column('institutions_institution', 'current_submission_id')

        # Deleting field 'Institution.current_subscription'
        db.delete_column('institutions_institution', 'current_subscription_id')
