...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.international'
        db.add_column('institutions_institution', 'international', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Institution.international'
        db.delete_column('institutions_institution', 'international')
