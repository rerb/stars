...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.access_level'
        db.add_column('institutions_subscription', 'access_level',
                      self.gf('django.db.models.fields.CharField')(default='Basic', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.access_level'
        db.delete_column('institutions_subscription', 'access_level')
