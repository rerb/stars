...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('institutions_institution', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('institutions_institution', 'slug')

        # Changing field 'Institution.contact_phone'
        db.alter_column('institutions_institution', 'contact_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')())
