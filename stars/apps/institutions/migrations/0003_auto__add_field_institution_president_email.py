...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.president_email'
        db.add_column('institutions_institution', 'president_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.president_email'
        db.delete_column('institutions_institution', 'president_email')
