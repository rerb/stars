...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('institutions_subscription', 'reason', self.gf('django.db.models.fields.CharField')(max_length='16', null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.reason'
        db.delete_column('institutions_subscription', 'reason')
