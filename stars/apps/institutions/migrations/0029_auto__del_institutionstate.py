...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('institutions_institutionstate', (
            ('latest_rated_submission_set', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='rated_submission', null=True, to=orm['submissions.SubmissionSet'], blank=True)),
