...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.contact_phone_ext'
        db.add_column('institutions_institution', 'contact_phone_ext', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Institution.stars_staff_notes'
        db.add_column('institutions_institution', 'stars_staff_notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Institution.contact_phone_ext'
        db.delete_column('institutions_institution', 'contact_phone_ext')

        # Deleting field 'Institution.stars_staff_notes'
        db.delete_column('institutions_institution', 'stars_staff_notes')
