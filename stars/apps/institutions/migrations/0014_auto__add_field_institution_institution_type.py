...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.institution_type'
        db.add_column('institutions_institution', 'institution_type',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.institution_type'
        db.delete_column('institutions_institution', 'institution_type')
