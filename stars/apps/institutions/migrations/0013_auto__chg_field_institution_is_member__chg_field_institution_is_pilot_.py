...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Institution.is_member'
        db.alter_column('institutions_institution', 'is_member', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Institution.is_pilot_participant'
        db.alter_column('institutions_institution', 'is_pilot_participant', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Institution.is_pcc_signatory'
        db.alter_column('institutions_institution', 'is_pcc_signatory', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Institution.is_member'
        db.alter_column('institutions_institution', 'is_member', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Institution.is_pilot_participant'
        db.alter_column('institutions_institution', 'is_pilot_participant', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Institution.is_pcc_signatory'
        db.alter_column('institutions_institution', 'is_pcc_signatory', self.gf('django.db.models.fields.BooleanField')())
