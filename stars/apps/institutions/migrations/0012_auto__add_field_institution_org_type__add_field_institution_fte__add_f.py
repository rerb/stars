...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.org_type'
        db.add_column('institutions_institution', 'org_type', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'Institution.fte'
        db.add_column('institutions_institution', 'fte', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Institution.is_pcc_signatory'
        db.add_column('institutions_institution', 'is_pcc_signatory', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Institution.is_member'
        db.add_column('institutions_institution', 'is_member', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Institution.is_pilot_participant'
        db.add_column('institutions_institution', 'is_pilot_participant', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Institution.country'
        db.add_column('institutions_institution', 'country', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Institution.org_type'
        db.delete_column('institutions_institution', 'org_type')

        # Deleting field 'Institution.fte'
        db.delete_column('institutions_institution', 'fte')

        # Deleting field 'Institution.is_pcc_signatory'
        db.delete_column('institutions_institution', 'is_pcc_signatory')

        # Deleting field 'Institution.is_member'
        db.delete_column('institutions_institution', 'is_member')

        # Deleting field 'Institution.is_pilot_participant'
        db.delete_column('institutions_institution', 'is_pilot_participant')

        # Deleting field 'Institution.country'
        db.delete_column('institutions_institution', 'country')
    ...
    models = {
        ...
        'institutions.institution': {
            ...
            'is_pcc_signatory': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_pilot_participant': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
