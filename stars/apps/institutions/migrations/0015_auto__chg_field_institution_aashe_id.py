...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Institution.aashe_id'
        db.alter_column('institutions_institution', 'aashe_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Institution.aashe_id'
        raise RuntimeError("Cannot reverse this migration. 'Institution.aashe_id' and its values cannot be restored.")
