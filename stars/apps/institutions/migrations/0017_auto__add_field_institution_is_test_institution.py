...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.is_test_institution'
        db.add_column('institutions_institution', 'is_test_institution',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.is_test_institution'
        db.delete_column('institutions_institution', 'is_test_institution')
    ...
    models = {
        ...
        'institutions.institution': {
            ...
            'is_test_institution': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
