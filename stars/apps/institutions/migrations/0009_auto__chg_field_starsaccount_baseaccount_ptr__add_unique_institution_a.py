...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StarsAccount.baseaccount_ptr'
        db.alter_column('institutions_starsaccount', 'baseaccount_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['institutions.BaseAccount'], unique=True, primary_key=True))

        # Adding unique constraint on 'Institution', fields ['aashe_id']
        db.create_unique('institutions_institution', ['aashe_id'])
    
    
    def backwards(self, orm):
        
        # Changing field 'StarsAccount.baseaccount_ptr'
        db.alter_column('institutions_starsaccount', 'baseaccount_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['institutions.BaseAccount'], unique=True))

        # Removing unique constraint on 'Institution', fields ['aashe_id']
        db.delete_unique('institutions_institution', ['aashe_id'])
