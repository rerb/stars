...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Subscription', fields ['end_date']
        db.create_index('institutions_subscription', ['end_date'])

        # Adding index on 'Subscription', fields ['start_date']
        db.create_index('institutions_subscription', ['start_date'])


    def backwards(self, orm):
        # Removing index on 'Subscription', fields ['start_date']
        db.delete_index('institutions_subscription', ['start_date'])

        # Removing index on 'Subscription', fields ['end_date']
        db.delete_index('institutions_subscription', ['end_date'])

        # Adding field 'Institution.is_participant'
        db.add_column('institutions_institution', 'is_participant',
