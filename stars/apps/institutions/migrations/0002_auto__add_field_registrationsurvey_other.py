...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegistrationSurvey.other'
        db.add_column('institutions_registrationsurvey', 'other', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'RegistrationSurvey.other'
        db.delete_column('institutions_registrationsurvey', 'other')
