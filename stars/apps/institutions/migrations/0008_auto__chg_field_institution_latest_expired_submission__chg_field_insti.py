...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.archived'
        db.add_column('institutions_subscription', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


        # Changing field 'Subscription.ms_institution'
        db.alter_column('institutions_subscription', 'ms_institution_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iss.Organization'], null=True))

        # Changing field 'Subscription.institution'
        db.alter_column('institutions_subscription', 'institution_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.Institution'], null=True))

    def backwards(self, orm):

        # Changing field 'Institution.latest_expired_submission'
        db.alter_column('institutions_institution', 'latest_expired_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['submissions.SubmissionSet'], on_delete=models.SET_NULL))

        # Changing field 'Institution.rated_submission'
        db.alter_column('institutions_institution', 'rated_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['submissions.SubmissionSet'], on_delete=models.SET_NULL))

        # Changing field 'Institution.current_subscription'
        db.alter_column('institutions_institution', 'current_subscription_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['institutions.Subscription'], on_delete=models.SET_NULL))

        # Changing field 'Institution.current_submission'
        db.alter_column('institutions_institution', 'current_submission_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['submissions.SubmissionSet'], on_delete=models.SET_NULL))
        # Deleting field 'Subscription.archived'
        db.delete_column('institutions_subscription', 'archived')


        # Changing field 'Subscription.ms_institution'
        db.alter_column('institutions_subscription', 'ms_institution_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iss.Organization'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Subscription.institution'
        db.alter_column('institutions_subscription', 'institution_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.Institution'], null=True, on_delete=models.SET_NULL))
