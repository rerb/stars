...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.profile'
        db.add_column('institutions_institution', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issdjango.Organizations'], null=True, blank=True), keep_default=False)
    
    def backwards(self, orm):
        
        # Deleting field 'Institution.profile'
        db.delete_column('institutions_institution', 'profile_id')
