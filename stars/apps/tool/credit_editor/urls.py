...
ct_prefix = "(?P<creditset_id>\d+)/(?P<category_id>\d+)/"
sb_prefix = "(?P<creditset_id>\d+)/(?P<category_id>\d+)/(?P<subcategory_id>\d+)/"
cr_prefix = "(?P<creditset_id>\d+)/(?P<category_id>\d+)/(?P<subcategory_id>\d+)/(?P<credit_id>\d+)/"
