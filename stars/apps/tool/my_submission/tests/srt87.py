...
class SRT87Test(ViewTest):
    ...
    def setUp(self):
        ...
        self.field = DocumentationFieldFactory(type='numeric', required=True, min_range=0)

        # Set up titles for the url
        self.field.credit.identifier = u"CR-1"
        self.field.credit.validation_rules = "if A < 0: errors['B'] = 'you have errors'"
        ...
        tabular_field_dict = {
                                ...
                                "colHeadings": ["Col 1"],
                                "numCols": 1}
        self.tabular_field = DocumentationFieldFactory(type='tabular',
                                               required=True,
...
#         self.submission = self.cus.get_submissionset()
    ...
    def test_get_succeeds(self, status_code=200, **kwargs):
        super(SRT87Test, self).test_get_succeeds(status_code, **self.view_kwargs)
