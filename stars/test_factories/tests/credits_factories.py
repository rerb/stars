...
class CreditSetFactoryTest(unittest.TestCase):
...
class SubCategoryFactoryTest(unittest.TestCase):
...
class CreditFactoryTest(unittest.TestCase):
...
class ApplicabilityreasonFactoryTest(unittest.TestCase):
...
class RatingFactoryTest(unittest.TestCase):
